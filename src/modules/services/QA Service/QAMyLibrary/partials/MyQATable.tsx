...
import { MyQATableBodyProps, MyQATableProps } from "../config/types";
import { NavLink } from "react-router-dom";
import { IoMdEye } from "react-icons/io";

const MyQATable: FC<MyQATableProps> = ({
  HeaderData,
  Link,
  itemData = [],
      ...
      <div className="flex justify-center w-full">
        <div className="overflow-x-auto w-full">
          <table className="table text-center w-full border border-collapse border-gray-800 text-xs">
            ...
            <tbody>
              {itemData?.map((item: MyQATableBodyProps, index) => (
                <tr key={index}>
