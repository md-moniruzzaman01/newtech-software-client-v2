...
import { BillServiceTableProps, TableBodyProps } from "../../config/types";

const BillServicePendingTable: FC<BillServiceTableProps> = ({
  HeaderData,
  Link,
  itemData = [],
}) => {
...
export default BillServicePendingTable;
