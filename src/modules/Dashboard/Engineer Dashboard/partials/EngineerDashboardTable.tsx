...
import { EngineerDashboardTableProps, TableBodyProps } from "../config/types";

const EngineerDashboardTable: FC<EngineerDashboardTableProps> = ({
  HeaderData,
  Link,
  itemData = [],
}) => {
...
export default EngineerDashboardTable;
