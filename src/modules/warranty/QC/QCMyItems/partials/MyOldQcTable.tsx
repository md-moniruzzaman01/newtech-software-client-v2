...
import { MyQCTableBodyProps, MyQCTableProps } from '../../QCMyLibrary/config/types';

const MyOldQcTable: FC<MyQCTableProps> = ({
    HeaderData,
    Link,
    itemData = [],
                                    ...
                                    <td className=" border border-gray-800">
                                        <label>
                                            <input
                                                type="checkbox"
                                                className="checkbox form-checkbox h-5 w-5 "
                                                checked={checkedRows.includes(item?.repair && item?.repair?.id || "")}
                                                onChange={() => handleCheckboxChange(item?.repair && item?.repair?.id || "")}
                                            />
                                        </label>
                                    </td>
