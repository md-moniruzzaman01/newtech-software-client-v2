      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border-t-4 border-green-500">
          ...
          <p>
            ...
            {complaintsSingleData?.customer?.email ||
              complaintsSingleData?.Nonwarrentycustomer?.email ||
              "N/A"}
          </p>
          <p>
            <span className="font-bold text-gray-700">Company:</span>{" "}
            {complaintsSingleData?.customer?.company ||
              complaintsSingleData?.Nonwarrentycustomer?.company ||
              "N/A"}
          </p>
          <p>
            <span className="font-bold text-gray-700">Address:</span>{" "}
            {complaintsSingleData?.customer?.address ||
              complaintsSingleData?.Nonwarrentycustomer?.address ||
              "N/A"}
          </p>
        </div>
      </div>
