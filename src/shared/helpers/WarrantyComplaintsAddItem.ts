import { PartnerProps, warrantyPartnerProps, warrantyUpdateAddedItemProps } from "../../modules/warranty/complaints/ComplaintAddForWarranty/config/types";
...
export const handleAddItem = (
    ...
    setPartnerInfo: React.Dispatch<React.SetStateAction<warrantyPartnerProps | null>>,
    setSelectedItem: React.Dispatch<React.SetStateAction<number | null>>,
    setSelectData: React.Dispatch<React.SetStateAction<warrantyUpdateAddedItemProps | null>>,
    setWarrantyAddedItem: React.Dispatch<React.SetStateAction<warrantyUpdateAddedItemProps[] | []>>,
) => {
...
export const updateData = (index: number,
    ...
    const selectedItemData: warrantyUpdateAddedItemProps = warrantyAddedItem[index];
